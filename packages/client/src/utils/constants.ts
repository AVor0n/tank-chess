...
/* URLS */
export const URL = 'http://tank-chess.ya-praktikum.tech'
export const BASE_URL = 'http://tank-chess.ya-praktikum.tech/api'
export const URL_RESOURCES = 'http://tank-chess.ya-praktikum.tech/resources/'
